...
pub use crate::opaque_impl::{client_register_start, client_register_finish, client_login_start, client_login_finish};
pub use crate::opaque_impl::{ClientStateRegistration, ClientRegistrationStartResult, ClientRegistrationFinishResult, ClientStateLogin, ClientLoginStartResult, ClientLoginFinishResult};
pub use crate::opaque_impl::{SHARED_SECRET_LEN, LOGIN_CLIENT_MESSAGE_LEN, REGISTER_CLIENT_MESSAGE_LEN, LOGIN_FINISH_MESSAGE_LEN, REGISTER_FINISH_MESSAGE_LEN};
...
mod tests {
    ...
    fn client_register_finish_output() {
        ...
        let response = client_register_finish(&mut state, password.as_bytes(), &server_message).unwrap();
